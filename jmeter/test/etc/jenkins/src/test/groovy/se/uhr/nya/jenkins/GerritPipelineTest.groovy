...
public class GerritPipelineTest extends BasePipelineTest {
	...
	void setUp() throws Exception {
		...
		getBinding().setVariable('params', [GERRIT_BRANCH: 'master', GERRIT_PROJECT: 'test', GERRIT_PATCHSET_REVISION: commitId, GERRIT_CHANGE_ID: changeId, GERRIT_HOST: 'nya-gerrit.its.umu.se'])
	}
